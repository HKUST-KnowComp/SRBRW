...
char **user;
int binary = 0, cbow = 1, debug_mode = 2, window = 5, min_count = 5, num_threads = 12, min_reduce = 1, max_path_length = 20, num_paths = 40, path_window = 1;
int *vocab_hash;
int *user_hash;
...
real alpha = 0.025, lambda = 8, starting_alpha, sample = 1e-3, r = 0.25, randomwalk_alpha = 0, p = 1, q = 1;
real l2norm_square_lowerbound, l2norm_square_upperbound;
...
int main(int argc, char **argv) {
    ...
    if ((i = ArgPos((char *)"-paths", argc, argv)) > 0) num_paths = atoi(argv[i + 1]);
